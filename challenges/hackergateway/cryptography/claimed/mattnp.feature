...
Característica: Resolver reto Claimed
  ...
  Escenario: Solución exitosa
    ...
    Cuando veo que el mensaje cifrado muestra carácteres numéricos
    Y noto son valores que rondan el valor de 100
    Y recuerdo que estos valores pueden ser código ASCII
    Y busco una herramienta en Internet para traducir código ASCII a texto
    Y encuentro que al traducir el mensaje obtengo la respuesta
